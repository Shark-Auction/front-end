  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="px-2 lg:px-0 lg:container mx-auto md:mt-10 flex flex-col gap-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full hidden-on-scroll fade-left">
          ...
          <div className="flex justify-center items-center w-full lg:w-1/2 h-[300px]">
            <p className="w-full lg:w-1/2 text-xl leading-relaxed">
              ...
              đây là nơi cho mọi người có thể thoải mái mua bán đa dạng sản phẩm
              qua hình thức đấu giá. Uy tín, dễ dùng và đa dạng.{" "}
              <span className="font-bold text-blue-600">Shark Auction</span> sẽ
              mang lại cơ hội cho bạn trải nghiệm “Thuận mua vừa bán”.
            </p>
          </div>
        </div>
      </div>
